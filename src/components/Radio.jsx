...
const Radio = ({ radioData }) => {
  ...
  const [req, setReq] = useState(radioData.radioReq);

  const [label, setLabel] = useState(radioData.radioLabel);
  ...
  return (
    <div className={styles.rad_cont}>
      <div className={styles.edit_cont}>
        ...
        {editMode && !radioData.submitStatus &&(
